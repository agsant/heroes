...
class HomeDisabler extends StatefulWidget{

  @override
  _HomeDisablerState createState() => _HomeDisablerState();
}

class _HomeDisablerState extends State<HomeDisabler> {

  @override
  void initState() {
    super.initState();
    Provider.of<HeroViewModel>(context, listen: false).fetchHeroes("disabler");
  }
  ...
  Widget build(BuildContext context) {
    ...
    Widget getDisablerHeroes(BuildContext context, ApiResponse apiResponse){
      ...
      switch (apiResponse.status) {
        ...
        case Status.ERROR:
          return Center(
            child: Text(apiResponse.message.toString()),
          );
      }
    }
    ...
    return getDisablerHeroes(context, apiResponse);
  }
}