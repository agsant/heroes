...
class HomeAllHeroes extends StatefulWidget{

  @override
  _HomeAllHeroesState createState() => _HomeAllHeroesState();
}

class _HomeAllHeroesState extends State<HomeAllHeroes> {

  @override
  void initState() {
    super.initState();
    Provider.of<HeroViewModel>(context, listen: false).fetchHeroes("all");
  }

  @override
  Widget build(BuildContext context) {
    final vm = Provider.of<HeroViewModel>(context);
    List<HeroModel> heroList = vm.heroes;
