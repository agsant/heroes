...
class HomeEscape extends StatefulWidget{

  @override
  _HomeEscapeState createState() => _HomeEscapeState();
}

class _HomeEscapeState extends State<HomeEscape> {


  @override
  void initState() {
    super.initState();
    Provider.of<HeroViewModel>(context, listen: false).fetchHeroes("escape");
  }
  ...
  Widget build(BuildContext context) {
    ...
    Widget getEscapeHeroes(BuildContext context, ApiResponse apiResponse){
    ...
    return getEscapeHeroes(context, apiResponse);
  }
}